...
# 确保 Python 可以找到 WAVES 目录
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))


# # 设定 DATA_DIR（确保它在 WAVES 目录的上层）
# os.environ["DATA_DIR"] = r"C:\Users\zyr\Desktop\PAr"

# # 打印调试信息，确认 DATA_DIR 是否被正确加载
# print(f"✅ DATA_DIR 设置成功: {os.environ.get('DATA_DIR')}")
...
def chmod():
    ...
    subprocess.run(
        [
            sys.executable,
            os.path.join(
                os.path.dirname(os.path.abspath(__file__)), "scripts/chmod.py"
            ),
        ]
    )
